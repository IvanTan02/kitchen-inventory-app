...
public class SelectedItemFragment extends Fragment implements ItemAdapter.ItemClickListener{

    DBHelper databaseHelper;
    ArrayList<String> itemDetails = new ArrayList<>();
    EditText etName, etCategory, etStorage, etQty;
    TextView tvSDate, tvEDate;
    Button btDelete, btModify;
    Item item;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btModify = (Button) rootView.findViewById(R.id.bt_modify);
        ...
        etQty = (EditText) rootView.findViewById(R.id.quantity);
        ...
        if (intent != null) {
            ...
            item = databaseHelper.getItemDetails(name);
        ...
        btModify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String category, storage, sDate, eDate, qty;
                ...
                if (!name.isEmpty() || !category.isEmpty() || !storage.isEmpty() || !qty.isEmpty()) {
                    databaseHelper.addItem(name, category, storage, sDate, eDate, qty);
                    Toast.makeText(rootView.getContext(), "Item Modified!", Toast.LENGTH_SHORT).show();
        ...
        btDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getActivity().getSupportFragmentManager().beginTransaction()
                        .replace(R.id.flFragment, inventoryFragment, "inventoryFragment")
                        .addToBackStack(null)
                        .commit();
            }
        });
